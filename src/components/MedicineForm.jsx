                ...
                <div className="p-5">
                    <div className="flex flex-col space-y-3">
                        ...
                        <div className="fields">
                            ...
                            <div className="fields">
                                <label htmlFor="uniPrice">Số Lượng:</label>
                                <input type="number" step="1" id="unitPrice" name="unitPrice" value={formState.unitPrice} onChange={HandleChange} className="w-32 input" />
                            </div>
